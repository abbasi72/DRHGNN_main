...
class UniSAGEConv(nn.Module):
    ...
    def __init__(self, args, in_channels, out_channels, heads=8, dropout=0.6, negative_slope=0.2):
        super().__init__()
        # TODO: bias?
...
class UniGNN(nn.Module):
    def __init__(self, args, nfeat, nhid, nclass, nlayer, nhead, V, E):
        ...
        self.convs = nn.ModuleList(
            [ Conv(args, nfeat, nhid, nhead, dropout=args.attn_drop)] +
    ...
    def forward(self, X):
        ...
        return F.log_softmax(X, dim=1)#sigmoid(X)
